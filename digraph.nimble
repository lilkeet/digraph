...
version       = "0.1.0"
author        = "lilkeet"
description   = "An implementation of directed graphs."
license       = "WTFPL"
srcDir        = "src"
...
type
  TestModule {.pure.} = enum
    DebugTools, UnsafeTables, Digraph, Acyclic

const
  PrivateModules = {DebugTools, UnsafeTables}
  VisibleModules = TestModule.fullset - PrivateModules
